...
import React__default, { forwardRef, useContext, useRef, useMemo, useDebugValue, createElement, useState } from 'react';
  ...
  function recurse(object) {
    ...
    Object.entries(object).forEach(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];
      if (!shouldSkipPaths || !shouldSkipPaths([].concat(_toConsumableArray(parentKeys), [key]))) {
...
var Ue = function Ue(e) {
  ...
  _Je = function Je(t) {
    ...
    for (var s in t) {
      var i = t[s];
      t.hasOwnProperty(s) && !Ue(i) && (Array.isArray(i) && i.isCss || oe(i) ? o.push("".concat(He(s), ":"), i, ";") : ce(i) ? o.push.apply(o, __spreadArray(__spreadArray(["".concat(s, " {")], _Je(i), false), ["}"], false)) : o.push("".concat(He(s), ": ").concat((n = s, null == (r = i) || "boolean" == typeof r || "" === r ? "" : "number" != typeof r || 0 === r || n in unitlessKeys || n.startsWith("--") ? String(r).trim() : "".concat(r, "px")), ";")));
    }
    return o;
  };
function Xe(e, t, n, r) {
...
var Menu = function Menu(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(rt, {
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, {
      ...
      href: item.link,
      passHref: true
    }, /*#__PURE__*/React__default.createElement(StyledLink, null, /*#__PURE__*/React__default.createElement(Icon, null, /*#__PURE__*/React__default.createElement(iconMap[item.icon] || "span")), !isCollapsed && item.label)) : /*#__PURE__*/React__default.createElement(StyledLink, {
      as: "button",
